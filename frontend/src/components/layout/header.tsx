			...
			<div className="mx-auto max-w-7xl px-6 sm:px-8">
				<div className="h-16 flex items-center justify-between">
					...
					<nav className="hidden md:flex items-center gap-8">
						<Link to="#features" className="text-sm text-neutral-400 hover:text-white transition-colors font-geist">
							Funcionalidades
						</Link>
						<Link to="#how-it-works" className="text-sm text-neutral-400 font-geist">
							Como Funciona
						</Link>
						<Link to="#pricing" className="text-sm text-neutral-400 hover:text-white transition-colors font-geist">
							Planos
						</Link>
						<Link to="#" className="text-sm text-neutral-400 hover:text-white transition-colors font-geist">
							Educação
						</Link>
